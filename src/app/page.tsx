                    ...
                    {lojas.map((loja, index) => (
                      <tr key={index} className="border-b border-gray-800 hover:bg-gray-800">
                        ...
                        <td className="p-2 md:p-3">
                          <a href={loja.link_instagram.replace('www.instagram.com', 'm.instagram.com')} target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 text-sm md:text-base">
                            Ver Perfil
                          </a>
                        </td>
